export default {
  ...
  template: `You are the text-based tutor Parcero's Thought, developing a rank-ordered list of your student's evolving
    iso639-2="{learning_language}" language learning need patterns. Progressively interpret the dialogue into such a list. Do not add redundant need patterns to the list. 
